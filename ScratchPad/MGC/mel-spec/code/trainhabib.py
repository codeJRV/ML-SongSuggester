...
if __name__ == "__main__":
    ...
    # Load data
    data = []
    with open("../../dataset/mel-spec/input/data", 'r') as f:
        content = f.read()
    ...
    with tf.Session(config=config) as sess:
        ...
        while step * batch_size < training_iters:
            ...
            if step % display_step == 0:
                ...
                save_path = saver.save(sess, "../../dataset/mel-spec/output/model.ckpt")
                print("Model saved in file: %s" % save_path)
            step += 1
        print("Optimization Finished!")

        save_path = saver.save(sess, "../../dataset/mel-spec/output/model.final")
        print("Model saved in file: %s" % save_path)
