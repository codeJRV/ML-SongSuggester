...
from utils import traintestsplit, save_data, load_dataset, save_dataset, sort_result, predict_label, load_gt, plot_confusion_matrix, extract_melgrams
...
songs_dataset_path="Music_Data/genres"
...
if LOAD_DB:
    if MULTIFRAMES:
        ...
        X_train,  y_train, num_frames_train  = load_dataset('music_dataset/music_dataset_multiframe_train.h5')
        X_test, y_test, num_frames_test = load_dataset('music_dataset/music_dataset_multiframe_test.h5')
    else:
...
# Compute mel-spectogram for all the frames
    ...
    train_songs_list,y_train,test_songs_list,y_test =traintestsplit(songs_dataset_path,train_test_split_ratio)
    X_train, num_frames_train = extract_melgrams(train_songs_list, MULTIFRAMES, process_all_song=False, num_songs_genre=20)
    print('X_train shape:', X_train.shape)
    X_test, num_frames_test = extract_melgrams(test_songs_list, MULTIFRAMES, process_all_song=False, num_songs_genre=10)
